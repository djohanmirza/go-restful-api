...
func (m *MockProductService) Delete(ctx context.Context, productId string) error {
	m.ctrl.T.Helper()
...
func (m *MockProductService) FindById(ctx context.Context, productId string) (web.ProductResponse, error) {
	m.ctrl.T.Helper()
