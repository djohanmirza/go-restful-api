...
func (m *MockEmployeeService) Delete(ctx context.Context, employeeId string) error {
	m.ctrl.T.Helper()
...
func (m *MockEmployeeService) FindById(ctx context.Context, employeeId string) (web.EmployeeResponse, error) {
	m.ctrl.T.Helper()
