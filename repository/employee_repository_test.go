...
func TestEmployeeRepository(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "Save Success",
			mock: func() {
				employee := domain.Employee{EmployeeID: "E001", Name: "John Doe", Role: "Manager"}
				repo.EXPECT().Save(ctx, employee).Return(employee, nil)
			},
			method: func() (interface{}, error) {
				return repo.Save(ctx, domain.Employee{EmployeeID: "E001", Name: "John Doe", Role: "Manager"})
			},
			expect:    domain.Employee{EmployeeID: "E001", Name: "John Doe", Role: "Manager"},
			expectErr: false,
		},
		{
			name: "Save Failure",
		...
		},
		{
			name: "Update Success",
			mock: func() {
				employee := domain.Employee{EmployeeID: "E001", Name: "Updated Name", Role: "Director"}
				repo.EXPECT().Update(ctx, employee).Return(employee, nil)
			},
			method: func() (interface{}, error) {
				return repo.Update(ctx, domain.Employee{EmployeeID: "E001", Name: "Updated Name", Role: "Director"})
			},
			expect:    domain.Employee{EmployeeID: "E001", Name: "Updated Name", Role: "Director"},
			expectErr: false,
		},
		{
			name: "FindById Success",
			mock: func() {
				repo.EXPECT().FindById(ctx, "E001").Return(domain.Employee{EmployeeID: "E001", Name: "John Doe", Role: "Manager"}, nil)
			},
			method: func() (interface{}, error) {
		...
		},
		{
			...
			mock: func() {
				repo.EXPECT().FindAll(ctx).Return([]domain.Employee{{EmployeeID: "E001", Name: "John Doe", Role: "Manager"}}, nil)
			},
			method: func() (interface{}, error) {
