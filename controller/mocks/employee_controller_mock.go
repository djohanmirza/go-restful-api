...
func (m *MockEmployeeController) Create(c *v2.Ctx) error {
	m.ctrl.T.Helper()
...
func (m *MockEmployeeController) Delete(c *v2.Ctx) error {
	m.ctrl.T.Helper()
...
func (m *MockEmployeeController) FindAll(c *v2.Ctx) error {
	m.ctrl.T.Helper()
...
func (m *MockEmployeeController) FindById(c *v2.Ctx) error {
	m.ctrl.T.Helper()
...
func (m *MockEmployeeController) Update(c *v2.Ctx) error {
	m.ctrl.T.Helper()
